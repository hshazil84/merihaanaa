              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    {comment.user_profiles?.avatar ? (
                      <img src={comment.user_profiles.avatar} alt=""
                    ...
                    <div>
                      <p className="font-body text-xs font-semibold text-foreground">
                        {comment.user_profiles?.full_name ?? "ނަމެއްނެތް"}
                      </p>
    ...
    <div className="max-w-4xl mx-auto px-6 py-8" dir="rtl">
      ...
      {filtered.length === 0 ? (
        <div className="flex items-center justify-center h-48 text-muted-foreground">
          <p className="font-body text-sm">ކޮމެންޓެއް ނެތް</p>
        </div>
      ) : (
        <div className="space-y-3">
          {filtered.map((comment) => (
