...
export default function AuthorsClient({ authors: initial }: Props) {
  ...
  async function toggleActive(author: Author) {
    ...
    if (!error) {
      setAuthors((prev) =>
        prev.map((a) => (a.id === author.id ? { ...a, is_active: next } : a))
      );
    }
  }
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto" dir="rtl">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          ...
          >
            ...
            <div className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div>
                ...
                <div className="flex items-center border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                  <span className="px-3 py-2 text-sm text-gray-400 bg-gray-50 dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 select-none">
                    @
                  </span>
                  <input
                    type="text"
              ...
              <div className="flex items-center justify-between py-1">
                ...
                >
                  <span
                    className={`absolute top-1 w-4 h-4 rounded-full bg-white dark:bg-gray-900 transition-all ${
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100 dark:border-gray-800">
              ...
              >
                {saving ? "ރައްކާ ކުރަނީ..." : editing ? "ބަދަލު ރައްކާ" : "ރައްކާ"}
              </button>
            </div>
          </div>
        </div>
      ...
      {deleteTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div
            className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-sm mx-4 p-6"
            dir="rtl"
          >
