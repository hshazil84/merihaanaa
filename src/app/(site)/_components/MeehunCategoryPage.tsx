...
const CSS = `
  ...
  @media (max-width: 1024px) {
    ...
    .meehun-col-left, .meehun-col-center, .meehun-ad-rail { display: none; }
...
export function MeehunCategoryPage({
  category, featuredArticle, recentArticles, articles,
}: {
  category: any; featuredArticle: any; recentArticles: any[]; articles: any[];
}) {
  ...
  return (
    <div style={{ backgroundColor: BG_PAGE, minHeight: "100vh" }} dir="rtl">
      ...
      {/* Desktop: 3-col grid */}
      <div style={{ maxWidth: "84rem", margin: "0 auto", padding: "0 1.5rem" }} className="meehun-grid">

        {/* LEFT: Recent circles — people's faces, in order, newest first */}
        ...
        {/* RIGHT: Ad rail */}
        <div className="meehun-ad-rail">
          <Suspense fallback={null}>
            <AdSlot id="meehun-hero-rail" breakpoint="desktop" />
          </Suspense>
        </div>
      ...
      {/* Mobile only */}
      <div className="meehun-mobile-only" style={{ maxWidth: "84rem", margin: "0 auto", padding: "0 1.5rem" }}>
        ...
        <div style={{ marginTop: "1.5rem", paddingTop: "1.25rem", borderTop: "0.5px solid " + DIVIDER }}>
          <Suspense fallback={null}>
            <AdSlot id="meehun-hero-rail" breakpoint="mobile" />
          </Suspense>
        </div>
      </div>

      {/* Divider */}
      <div style={{ maxWidth: "84rem", margin: "2rem auto 1.5rem", padding: "0 1.5rem" }}>
        <div style={{ borderTop: "0.5px solid " + DIVIDER }} />
      </div>

      {/* Teaser grid */}
      {articles.length > 0 && (
        <div style={{ maxWidth: "84rem", margin: "0 auto", padding: "0 1.5rem 2rem" }}>
      ...
      <div style={{ maxWidth: "84rem", margin: "0 auto", padding: "0 1.5rem 4rem", display: "flex", justifyContent: "center", paddingTop: "1rem", borderTop: "0.5px solid " + DIVIDER }}>
        <Link href={"/" + category.slug + "/archive"}
          style={{ fontFamily: FONT_THAANA, fontSize: "12px", fontWeight: 700, color: CORAL, textDecoration: "none", padding: "8px 20px", border: "0.5px solid " + CORAL, borderRadius: "8px" }}>
          {"އިތުރު ލިޔުންތައް ←"}
        </Link>
      </div>
