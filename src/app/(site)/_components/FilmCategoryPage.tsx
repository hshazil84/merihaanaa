...
const CSS = [
  ...
  ".film-hero-text{min-width:0;overflow:hidden;padding-inline-start:1.5rem;}",
  ...
  "@media(max-width:768px){.film-hero{grid-template-columns:minmax(0,1fr)!important;gap:1.25rem!important;}.film-hero-text{padding-inline-start:0!important;}.film-3col{grid-template-columns:repeat(2,minmax(0,1fr))!important;}.film-review-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;}}",
