...
async function getHomeData() {
  ...
  const [
    ...
    supabase.from("articles").select("id, title, slug, excerpt, featured_image, cover_portrait_url, reading_time_minutes, category:categories!category_id(name, slug)").eq("status", "published").eq("homepage_placement", "review")
